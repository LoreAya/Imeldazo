...
public class PictureController implements Serializable {
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("PictureCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("PictureUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("PictureDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<Picture> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<Picture> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class PictureControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Picture) {
                ...
                return getStringKey(o.getIdPicture());
            } else {
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Picture.class.getName()});
                return null;
            }
        }
